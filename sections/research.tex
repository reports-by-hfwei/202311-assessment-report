...
%%%%%%%%%%%%%%%%%%%%
\begin{frame}{}
	\fig{width = 0.80\textwidth}{figs/research}
\end{frame}
%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%%%%%%%%%%
\begin{frame}{}
	\fig{width = 1.00\textwidth}{figs/VLDB}
	\fig{width = 1.00\textwidth}{figs/SIGMOD}
	\fig{width = 0.90\textwidth}{figs/TPDS}
\end{frame}
%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}{}
  \begin{center}
		\red{\bf 进行中:} 设计专用的事务一致性理论求解器, 初见成效
