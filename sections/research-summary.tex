...
%%%%%%%%%%%%%%%%%%%%
\begin{frame}{科研方面: 获得奖励}
  \fig{width = 0.30\textwidth}{figs/ccf}
  
  \begin{center}
    \blue{2017年 CCF 优秀博士学位论文奖} \\[8pt]
    博士论文: ``分布数据一致性技术研究''
  \end{center}
\end{frame}
%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}{人才培养方面}
  ...
  \begin{columns}
	...
	\item 协助指导博士生: 3名
      \end{itemize}
      \fig{width = 0.70\textwidth}{figs/tlaplus-lamport-projects-github}
    \column{0.35\textwidth}
      \fig{width = 0.80\textwidth}{figs/tlaplus-seminar}
    \column{0.35\textwidth}
      \fig{width = 0.40\textwidth}{figs/coq-rock-github}
      \vspace{-0.50cm}
      \fig{width = 0.80\textwidth}{figs/coq-seminar}
  \end{columns}
\end{frame}
%%%%%%%%%%%%%%%%%%%%
